...
function Certifications() {
  return (
    <div className="h-screen bg-black relative overflow-y-auto">
      ...
      <section id="certifications" className="relative py-20 px-4 pt-24">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Certification Cards - Add your actual certifications here */}
            <div className="bg-black/40 backdrop-blur-sm border border-blue-500/20 rounded-lg p-6 hover:border-blue-400/40 transition-all duration-300 transform hover:scale-105">
              ...
              <p className="text-blue-300 font-medium mb-2">Issuing Organization</p>
              <p className="text-blue-200 text-sm mb-4">Issued: Month Year</p>
              <div className="flex items-center justify-between">
                <span className="text-xs bg-blue-600/20 text-blue-300 px-2 py-1 rounded">Credential ID</span>
            ...
            <div className="bg-black/40 backdrop-blur-sm border border-blue-500/20 rounded-lg p-6 hover:border-blue-400/40 transition-all duration-300 transform hover:scale-105">
              ...
              <h3 className="text-xl font-bold text-white mb-2">Certification Title</h3>
              <p className="text-green-300 font-medium mb-2">Issuing Organization</p>
              <p className="text-blue-200 text-sm mb-4">Issued: Month Year</p>
              <div className="flex items-center justify-between">
                <span className="text-xs bg-green-600/20 text-green-300 px-2 py-1 rounded">Credential ID</span>
            ...
            <div className="bg-black/40 backdrop-blur-sm border border-blue-500/20 rounded-lg p-6 hover:border-blue-400/40 transition-all duration-300 transform hover:scale-105">
              ...
              <h3 className="text-xl font-bold text-white mb-2">Certification Title</h3>
              <p className="text-purple-300 font-medium mb-2">Issuing Organization</p>
              <p className="text-blue-200 text-sm mb-4">Issued: Month Year</p>
              <div className="flex items-center justify-between">
                <span className="text-xs bg-purple-600/20 text-purple-300 px-2 py-1 rounded">Credential ID</span>
          ...
          <div className="text-center mt-12">
            <p className="text-blue-200 mb-4">More certifications coming soon...</p>
